...
function StatsBar() {
  ...
  const stats = [
    [
      precio ? `${precio}€` : "TBD",
      "por equipo. Pendiente de confirmar el formato definitivo y la sede.",
      precio ? null : "POR CONFIRMAR",
    ],
    [
      "100%",
      "de la recaudación va a Burundi: material sanitario y reconstrucción de clínicas en zonas rurales.",
      null,
    ],
    ...
    >
      <div className="wrap">
        ...
        >
          ...
          />
          {precio || 60}€ = tres rondas de cerveza. O agua corriente para una
          clínica entera.
        </div>
      </div>
