...
function HowItWorks() {
  const steps = [
    [
      "01",
      "Reúne a tu equipo",
      "Mayores de 16. Equipos mixtos o cerrados, como queráis. Si te falta gente, escríbenos y emparejamos. Nadie se queda fuera por número.",
    ],
    [
      "02",
      "Escribe por WhatsApp",
      "+34 644 89 35 71. Una línea basta: nombre del capitán + nombre del equipo. Te confirmamos en 24h.",
    ],
    [
      "03",
      "Sábado 27, 10:00",
      "Arrancamos a las diez. Te enviamos la sede y la hora de tu primer partido por WhatsApp. Llega, juega, quédate a comer y a tomar algo.",
    ],
  ];
  ...
  return (
    <section id="como" className="cream">
      <div
        className="bignum"
        style={{ top: 40, right: -40, fontSize: "clamp(180px, 22vw, 360px)" }}
      >
        02
      </div>
      ...
      <div className="wrap" style={{ position: "relative" }}>
        <div className="sec-header">
          ...
          <p className="lead">
            ...
            como te apuntarías a una pachanga — porque, técnicamente, eso es lo
            que es.
          </p>
        </div>
