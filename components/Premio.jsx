      ...
      <div className="wrap" style={{ position: "relative" }}>
        <div className="sec-header">
          ...
          <h2 className="premio-h2">
            ...
            <br />Y vete con la{" "}
            <span
              className="brush premio-h2-brush"
              style={{
        ...
        {/* ===== Row 1 — team prize ===== */}
        <div
          className="premio-row premio-row-team"
          style={{
            display: "grid",
        ...
        >
          ...
          >
            <div
              className="premio-jerseys"
              style={{
                position: "relative",
                background:
                  "linear-gradient(180deg, rgba(11,21,37,0) 0%, rgba(11,21,37,0.45) 100%), var(--ny-navy-900)",
                minHeight: 320,
                display: "flex",
                alignItems: "flex-end",
            ...
            >
              ...
              <div
                ...
                style={{
                  ...
                  height: 26,
                  background:
                    "radial-gradient(ellipse at center, rgba(245,197,24,0.30), transparent 70%)",
                  filter: "blur(2px)",
                  pointerEvents: "none",
                }}
              />
            ...
            <div style={{ padding: 32 }}>
              ...
              >
                Las equipaciones oficiales que Adidas estrena con la Roja este
                verano en EE.UU., México y Canadá. Para el equipo campeón.
              </p>
            </div>
          </article>
          ...
          >
            ...
            >
              <div
                ...
                style={{
                  ...
                  height: 22,
                  background:
                    "radial-gradient(ellipse at center, rgba(245,197,24,0.28), transparent 70%)",
                  filter: "blur(2px)",
                  pointerEvents: "none",
                }}
              />
            ...
            <div style={{ padding: 32 }}>
              ...
              >
                Una caja de vinos para que el equipo campeón descorche después
                del último silbato y brinde por la victoria.
              </p>
            </div>
          </article>
        </div>
        ...
        <div
          className="premio-row premio-row-individual"
          style={{
            display: "grid",
            gridTemplateColumns: "repeat(2, 1fr)",
            gap: 22,
        ...
        >
          {/* Card C — Pichichi */}
          <article
            className="premio-card premio-surprise"
            style={{
              background: "var(--ny-navy-700)",
              border: "1px solid var(--line)",
              padding: 32,
          ...
          >
            ...
            >
              Sorpresa para el que más{" "}
              <span style={{ color: "var(--ny-gold)" }}>marca</span>.
            </h3>
            <p
              style={{
                fontSize: 15,
            ...
            >
              El jugador con más goles del torneo se lleva un premio individual.
              No lo enseñamos antes. Lo ves cuando lo ganas.
            </p>
          </article>
          ...
          >
            ...
            >
              Elegido por árbitros y organización entre los que han hecho la
              mañana — defendiendo, asistiendo, sosteniendo al equipo. Premio
              individual y sorpresa hasta el trofeo.
            </p>
          </article>
        </div>
        ...
        >
          ...
          <span>
            ...
            organización lo confirma antes, lo verás aquí — pero la sorpresa
            individual se mantiene cerrada hasta el trofeo.
          </span>
        </div>
      </div>
